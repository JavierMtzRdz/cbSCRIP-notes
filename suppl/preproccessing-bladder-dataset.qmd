...
bladder_fpd1 <- read_delim(here::here("data/GSE5479_Final_processed_data_1.txt"))
bladder_fpd2 <- read_delim(here::here("data/GSE5479_Final_processed_data_2.txt"))
...
bladder_hd <- read_xls(here::here("data/6517200/10780432ccr062940-sup-supplemental_file_1.xls")) %>% 
    clean_names() %>% 
...
saveRDS(bladder_comp_adj,
        here("data", "bladder_comp_adj.rds"))
